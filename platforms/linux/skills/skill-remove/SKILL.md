...
name: skill-remove
description: >-
  Plan and carry out an explicitly requested skill retirement on Linux with
...
Inspect affected symlinks, profile entries, router/index references, and variants.
...
in a dated backup directory. Operate on installed links themselves, never delete
